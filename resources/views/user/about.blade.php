            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="tpabout__inner-thumb mb-40">
                        <img src="user/assets/img/banner/about-img-1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="tpabout__inner-thumb mb-40">
                        <img src="user/assets/img/banner/about-img-2.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="tpabout__logo">
                <a href="index.html"><img src="user/assets/img/banner/about-img-3.png" alt=""></a>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12">
                <div class="tpabout__inner-list mb-40">
                    <ul>
                        <li> <a href="#"><i class="fal fa-check"></i> Orders go right to your restaurant point of sale,
                                KDS, and kitchen</a>
                        </li>
                        <li> <a href="#"><i class="fal fa-check"></i> Provide in-person pickup, & delivery by
                                professional couriers</a>
                        </li>
                        <li><a href="#"><i class="fal fa-check"></i> Offer in-person diners self-serve, contactless
                                ordering via QR codes.</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="swiper-container tp-team-active">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="tpteam__item p-relative mb-40">
                        <div class="tpteam__thumb">
                            <img src="user/assets/img/testimonial/team-1.jpg" alt="">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="tpteam__item p-relative mb-40">
                        <div class="tpteam__thumb">
                            <img src="user/assets/img/testimonial/team-2.jpg" alt="">
                        </div>
                        <div class="tpteam__content">
                ...
                <div class="swiper-slide">
                    <div class="tpteam__item p-relative mb-40">
                        <div class="tpteam__thumb">
                            <img src="user/assets/img/testimonial/team-3.jpg" alt="">
                        </div>
                        <div class="tpteam__content">
                ...
                <div class="swiper-slide">
                    <div class="tpteam__item p-relative mb-40">
                        <div class="tpteam__thumb">
                            <img src="user/assets/img/testimonial/team-4.jpg" alt="">
                        </div>
                        <div class="tpteam__content">
...
<section class="feature-area pt-70 pb-10">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="tpfeature__inner-thumb mb-70">
                    <img src="user/assets/img/banner/about-banner-1.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="tpfeature__inner-thumb mb-70">
                    <img src="user/assets/img/banner/about-banner-2.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
