                                ...
                                <div class="tp-slide-item">
                                    <div class="tp-slide-item__content">
                                        ...
                                        <h3 class="tp-slide-item__title mb-25">Up To
                                            <i>40% Off
                                                <img src="user/assets/img/icon/title-shape-02.jpg" alt="">
                                            </i>
                                            latest Creations
                                        </h3>
                                    ...
                                    <div class="tp-slide-item__img">
                                        <img src="user/assets/img/slider/banner-1.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-slide-item">
                                    <div class="tp-slide-item__content">
                                        ...
                                        <h3 class="tp-slide-item__title mb-25">Up To <i>35% Off <img
                                                    src="user/assets/img/icon/title-shape-02.jpg" alt=""></i>
                                            latest Creations</h3>
                                        <a class="tp-slide-item__slide-btn tp-btn" href="shop.html">Shop Now <i
                                                class="fal fa-long-arrow-right"></i></a>
                                    </div>
                                    <div class="tp-slide-item__img">
                                        <img src="user/assets/img/slider/banner-2.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-slide-item">
                                    ...
                                    <div class="tp-slide-item__img">
                                        <img src="user/assets/img/slider/banner-3.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="tpslider-banner tp-slider-sm-banner mb-30">
                            <a href="shop-details.html">
                                <div class="tpslider-banner__img">
                                    <img src="user/assets/img/slider/banner-slider-01.jpg" alt="">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="tpslider-banner">
                            <a href="shop-details.html">
                                <div class="tpslider-banner__img">
                                    <img src="user/assets/img/slider/banner-slider-02.jpg" alt="">
                                    <div class="tpslider-banner__content">
                                        <span class="tpslider-banner__sub-title">Popular</span>
                                        <h4 class="tpslider-banner__title">Energy with our <br> newest
                                            collection</h4>
                                    </div>
                                </div>
                            </a>
            ...
            <div class="col-md-12">
                <div class="tpsection mb-40">
                    <h4 class="tpsection__title">Top <span> Categories <img
                                src="user/assets/img/icon/title-shape-01.jpg" alt=""></span></h4>
                </div>
            </div>
        </div>
                ...
                <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-1.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-2.jpg" alt="">
                                </a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details.html">
                                    <img src="user/assets/img/product/home-one/product-3.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-4.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-5.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-6.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-7.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-8.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-9.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-10.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-11.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-12.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-13.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-14.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-15.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-16.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-17.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-18.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html">
                                    <img src="user/assets/img/product/home-one/product-19.jpg" alt="product-thumb">
                                    <img class="product-thumb-secondary"
                                        src="user/assets/img/product/home-one/product-20.jpg" alt="">
                                </a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
            ...
            <div class="tab-pane fade" id="nav-rate" role="tabpanel" aria-labelledby="nav-rate-tab">
                <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1">
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="user/assets/img/product/home-one/product-5.jpg"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details.html"><img
                                        src="user/assets/img/product/home-one/product-6.jpg" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
                        ...
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-2.jpg" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-4.jpg" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="user/assets/img/product/home-one/product-19.jpg"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="#"><img
                                        src="user/assets/img/product/home-one/product-20.jpg" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-8.jpg" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="user/assets/img/product/home-one/product-9.jpg"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-10.jpg" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="user/assets/img/product/home-one/product-15.jpg"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-16.jpg" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="user/assets/img/product/home-one/product-17.jpg"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-18.jpg" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <span class="tpproduct__thumb-volt"><i class="fas fa-bolt"></i></span>
                                <a href="shop-details-2.html"><img src="user/assets/img/product/home-one/product-11.jpg"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-12.jpg" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="user/assets/img/product/home-one/product-13.jpg"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="user/assets/img/product/home-one/product-14.jpg" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="tpdealproduct">
                        <div class="tpdealproduct__thumb p-relative text-center">
                            <img src="user/assets/img/floded/floded-01.png" alt="dealproduct-thumb">
            ...
            <div class="shopslider-active swiper-container">
                <div class="swiper-wrapper">
                    <div class="tpshopitem swiper-slide">
                        <a class="popup-image" href="user/assets/img/instagram/instagram-01.jpg">
                            <img src="user/assets/img/instagram/instagram-01.jpg" alt="shop-thumb">
                        </a>
                    </div>
                    <div class="tpshopitem swiper-slide">
                        <a class="popup-image" href="user/assets/img/instagram/instagram-02.jpg">
                            <img src="user/assets/img/instagram/instagram-02.jpg" alt="shop-thumb">
                        </a>
                    </div>
                    <div class="tpshopitem swiper-slide">
                        <a class="popup-image" href="user/assets/img/instagram/instagram-03.jpg">
                            <img src="user/assets/img/instagram/instagram-03.jpg" alt="shop-thumb">
                        </a>
                    </div>
                    <div class="tpshopitem swiper-slide">
                        <a class="popup-image" href="user/assets/img/instagram/instagram-04.jpg">
                            <img src="user/assets/img/instagram/instagram-04.jpg" alt="shop-thumb">
                        </a>
                    </div>
                    <div class="tpshopitem swiper-slide">
                        <a class="popup-image" href="user/assets/img/instagram/instagram-05.jpg">
                            <img src="user/assets/img/instagram/instagram-05.jpg" alt="shop-thumb">
                        </a>
                    </div>
                    <div class="tpshopitem swiper-slide">
                        <a class="popup-image" href="user/assets/img/instagram/instagram-06.jpg">
                            <img src="user/assets/img/instagram/instagram-06.jpg" alt="shop-thumb">
                        </a>
                    </div>
                </div>
            </div>
