        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-2 col-lg-3">
                    <div class="logo">
                        <a href="{{url('/')}}"><img src="{{asset('user/assets/img/logo/logo.png')}}" alt="logo"></a>
                    </div>
                </div>
                        ...
                        <div class="header-meta header-language d-flex align-items-center">
                            <div class="header-meta__lang">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img src="{{asset('user/assets/img/icon/lang-flag.png')}}" alt="flag">English
                        ...
                        {{-- <div class="cat-menu__category p-relative">
                            ...
                            <div class="category-menu category-menu-off">
                                <ul class="cat-menu__list">
                                    ...
                                    <li class="menu-item-has-children"><a href="{{url('shop')}}"><i
                                ...
                                <ul>
                                    <li class="">
                                        ...
                                        {{-- <ul class="submenu">
                                            ...
                                            <li><a href="{{url('/')}}">Fashion Home</a></li>
                                            <li><a href="{{url('/')}}">Furniture Home</a></li>
                                            <li><a href="{{url('/')}}">Cosmetics Home</a></li>
                                            <li><a href="{{url('/')}}">Food Grocery</a></li>
                                        </ul> --}}
                                    </li>
                                    <li class="has-dropdown">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            {{-- <li><a href="{{url('shop')}}">Shop Details 2</a></li>
                                            <li><a href="{{url('shop')}}">Shop Location</a></li> --}}
                                        ...
                                        <ul class="submenu mega-menu">
                                            {{-- <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{url('shop')}}">Shop filters v2</a></li>
                                                    <li><a href="{{url('shop')}}">Shop sidebar</a></li>
                                                    <li><a href="{{url('shop')}}">Shop Right sidebar</a></li>
